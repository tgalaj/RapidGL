...
#define POINT_LIGHT_INDEX_LIST_SSBO_BINDING_INDEX    6
#define SPOT_LIGHT_INDEX_LIST_SSBO_BINDING_INDEX     7
#define POINT_LIGHT_GRID_SSBO_BINDING_INDEX          8
#define SPOT_LIGHT_GRID_SSBO_BINDING_INDEX           9
#define UNIQUE_ACTIVE_CLUSTERS_SSBO_BINDING_INDEX    10
#define CULL_LIGHTS_DISPATCH_ARGS_SSBO_BINDING_INDEX 11
